# Operator Quickstart — Fund management activities

Shortest path from clone to a verified local dry-run for **ISIC 6630** (`cloud-itonami-isic-6630`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6630.git
cd cloud-itonami-isic-6630
```
...
- Blueprint governor key: `fund-management-governor`
- Likely source path: `fundmgmt.governor.cljc`
